...
export default function ProjectCard({ title, description, technologies, links = [], image }: Props) {
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {technologies.map((tech) => (
            <span key={tech} className="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded text-sm font-medium">
              {tech}
            </span>
          ))}
        </div>
