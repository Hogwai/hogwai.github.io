...
As stated in the Lombok documentation, `@Data` is primarily designed for simple POJOs<sup><a href="#ref-lombok-documentation-for-data">[1]</a></sup> (i.e. for DTOs and value objects).
...
- <a id="ref-lombok-documentation-for-data"></a>[Lombok documentation for @Data](https://projectlombok.org/features/Data)
