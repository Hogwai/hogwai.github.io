...
Comme indiqué dans la documentation de Lombok, `@Data` est principalement conçu pour les POJOs simples<sup><a href="#ref-documentation-lombok-pour-data">[1]</a></sup> (c'est-à-dire pour les DTOs et les objets-valeur).
...
- <a id="ref-documentation-lombok-pour-data"></a>[Documentation Lombok pour @Data](https://projectlombok.org/features/Data)
